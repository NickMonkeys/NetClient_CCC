...
class CustomGizmo extends Editor.Gizmo {
    ...
    createGizmoCallBacks () {
        ...
        return {
            ...
            start: (x, y, event) => {
                ...
                this.target.polygonPoints.push(recentPoint);
            },
            ...
            update: (dx, dy, event) => {
                ...
                if (this.target.polygonPoints) {
                    cc.log('haha');
                    return;
                }
                this.target.polygonPoints[this.target.polygonPoints.length - 1] = recentPoint; 
    ...
    getOutLinePointsInView(){
        ...
        let points = target.polygonPoints;
        let pointsInView = [];
        for(let i of points){
